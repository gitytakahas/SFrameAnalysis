...
inputsamples = [
          ...
          # [ 'DATAX', ['DataPeriodBD','DataPeriodEH','DataPeriodI','DataPeriodJ','DataPeriodK','DataPeriodL','DataPeriodM'], ["_"+channel] ]
          ]
...
ComparisonHistograms += [MyHistNames]
