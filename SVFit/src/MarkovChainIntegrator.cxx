#include "../SVFit/include/MarkovChainIntegrator.h"

//#include "FWCore/MessageLogger/interface/MessageLogger.h"
//#include "FWCore/Utilities/interface/Exception.h"

#include "../SVFit/include/generalAuxFunctions.h"
...
std::string name,
std::string moveMode_string,
std::string initMode_string,
unsigned numIterBurnin,
unsigned numIterSampling,
unsigned maxCallsStartingPos,
unsigned numIterSimAnnealingPhase1,
unsigned numIterSimAnnealingPhase2,
double T0, 
double alpha,
unsigned numChains,
unsigned numBatches,
...
//--- get parameters defining maximum number of attempts to find a valid starting-position for the Markov Chain
  maxCallsStartingPos_ = ( maxCallsStartingPos>0 ) ?
    // maxCallsStartingPos : 1000000; 
    maxCallsStartingPos : 150000;
...
//        for each integration, in order to make integration results independent of processing history
  ...
  for ( unsigned iChain = 0; iChain < numChains_; ++iChain ) {
	...
	std::cerr
	  << "Requested start-position = " << format_vdouble(q_) << " returned probability zero --> searching for valid alternative !!  numChains_"<<numChains_  ;
      }
    }    
    unsigned iTry = 0;
