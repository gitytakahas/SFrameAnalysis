...
NSVfitStandaloneAlgorithm::integrateMarkovChain()
{
  ...
  if(isInitialized2_){
    ...
    // initialize    
    integrator2_ = new MarkovChainIntegrator(
    "NSVfitStandaloneAlgorithm",
    "Metropolis",
    "none",
    TMath::Nint(0.10*maxObjFunctionCalls2_),
    maxObjFunctionCalls2_,
    0,
    TMath::Nint(0.02*maxObjFunctionCalls2_),
    TMath::Nint(0.06*maxObjFunctionCalls2_),
    15.,
    1.0 - 1.e+2/maxObjFunctionCalls2_,
    1,
    1,
    1,
    1.e-2,
  ...
  */
  ...
  fittedDiTauSystem_ = ROOT::Math::PtEtaPhiMVector(pt_, eta_, phi_, mass_);
  if(verbosity_ > 0){
