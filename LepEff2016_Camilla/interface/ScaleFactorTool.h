...
class ScaleFactorTool  : public SToolBase   {
	...
	TH1D* etaBinsH_IDMu;	
	TH2D* etaptBinsH_IDMu;
	TH2D* etaptBinsH_IsoMu;
	
	TH2D* etaptBinsH_TrigEle;
	TH1D* etaBinsH_IDEle; 
	TH2D* etaptBinsH_IDEle;
	TH1D* etaBinsH_IDIsoEle; 
	TH2D* etaptBinsH_IDIsoEle;
	TH1D* etaBinsH;
	...
	double get_EfficiencyTrigEle(double, double);
	double get_ScaleFactor_IDEleIchep(double, double);
	double get_ScaleFactor_IDIsoEleIchep(double, double);
