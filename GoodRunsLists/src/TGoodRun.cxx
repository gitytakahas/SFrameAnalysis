// $Id: TGoodRun.cxx 45093 2010-08-20 11:58:27Z krasznaa $
...
namespace Root {
   ...
   TGoodRun::TGoodRun()
      : std::vector< TLumiBlockRange >(), TObject(), m_runnr( -1 ) {

   }

   TGoodRun::TGoodRun( const Int_t& runnr )
      : std::vector< TLumiBlockRange >(), TObject(), m_runnr( runnr ) {

   }

   TGoodRun::TGoodRun( const Root::TGoodRun& other )
      : std::vector< TLumiBlockRange >( other ), TObject( other ),
        m_runnr( other.m_runnr ) {

   }

   TGoodRun& TGoodRun::operator=( const TGoodRun& other ) {
   ...
   const TGoodRun TGoodRun::GetOverlapWith( const TGoodRun& other ) const {

      const Int_t runnr = ( this->GetRunNumber() == other.GetRunNumber() ?
                            this->GetRunNumber() : -1 );
   ...
   const TGoodRun TGoodRun::GetSumWith( const TGoodRun& other ) const {
   ...
   const TGoodRun TGoodRun::GetPartOnlyIn( const TGoodRun& other ) const {

      return other.GetPartNotIn( *this );
   }

   const TGoodRun  TGoodRun::GetPartNotIn( const TGoodRun& other ) const {
   ...
   Bool_t TGoodRun::HasLB( const Int_t& lumiblocknr ) const {
   ...
   std::vector< TLumiBlockRange >::iterator TGoodRun::Find( const Int_t& lumiblocknr ) {
   ...
   void TGoodRun::Summary () const {

      SLogger logger( "TGoodRun" );
      logger << INFO << "Run: " << m_runnr << SLogger::endmsg;
   ...
   void TGoodRun::AddLB( const Int_t& lumiblocknr ) {
